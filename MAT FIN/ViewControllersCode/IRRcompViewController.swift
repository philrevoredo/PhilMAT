...
class IRRcompViewController: UIViewController,UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        gg.setGradientBackground(colorOne: FlatSand(), colorTwo: FlatWhite()) //   pp.delegate = self
